...
| Pin Name      | Get Status          | Request Enable      | Request Disable  | Response  JSON   | Error  JSON                     |
| ------------- | --------------------| --------------------|------------------|------------------|---------------------------------|
| Pin A0        | baseUrl/A0          | baseUrl/A0={1..255} | baseUrl/A0=0     | {"A0":"'value'"} | {"Error":"'Error Description'"} |
| Pin A1        | baseUrl/A1          | baseUrl/A1={1..255} | baseUrl/A1=0     | {"A1":"'value'"} | {"Error":"'Error Description'"} |
| Pin A2        | baseUrl/A2          | baseUrl/A2={1..255} | baseUrl/A2=0     | {"A2":"'value'"} | {"Error":"'Error Description'"} |
| Pin A3        | baseUrl/A3          | baseUrl/A3={1..255} | baseUrl/A3=0     | {"A3":"'value'"} | {"Error":"'Error Description'"} |
| Pin A4        | baseUrl/A4          | baseUrl/A4={1..255} | baseUrl/A4=0     | {"A4":"'value'"} | {"Error":"'Error Description'"} |
| Pin A5        | baseUrl/A5          | baseUrl/A5={1..255} | baseUrl/A5=0     | {"A5":"'value'"} | {"Error":"'Error Description'"} |
